...
def main():
    ...
    for dir in os.listdir(img_dir):
        print("dir==",dir)
        args.work_dir='./work_dirs/experiments/res/'+dir
        imgs_root=os.path.join(img_dir,dir)
        cfg.__setattr__('imgs_root',imgs_root)
        data=cfg.__getattr__('data')
        data.train.dataset.imgs_root=imgs_root
        data.val.imgs_root=imgs_root
        cfg.__setattr__('data',data)
