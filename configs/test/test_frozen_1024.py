...
lr_config = None
checkpoint_config = dict(interval=20, by_epoch=False, max_keep_ckpts=20)
custom_hooks = [
...
resume_from='work_dirs/experiments/test_frozen_70/ckpt/test_frozen_70/iter_400.pth'